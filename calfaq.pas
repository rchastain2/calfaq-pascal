 ...
 *)
function is_leap(style: cint; year: cint): cint; cdecl; external;
 ...
 *)
function days_in_month(style: cint; year: cint; month: cint): cint; cdecl; external;
 ...
 *)
function solar_number(year: cint): cint; cdecl; external;
 ...
 *)
function day_of_week(style: cint; year: cint; month: cint; day: cint): cint; cdecl; external;
 ...
 *)
function golden_number(year: cint): cint; cdecl; external;
 ...
 *)
function epact(style: cint; year: cint): cint; cdecl; external;
 ...
 *)
procedure paschal_full_moon(style: cint; year: cint; var month: cint; var day: cint); cdecl; external;
 ...
 *)
procedure easter(style: cint; year: cint; var month: cint; var day: cint); cdecl; external;
 ...
 *)
procedure simple_gregorian_easter(year: cint; var month: cint; var day: cint); cdecl; external;
 ...
 *)
function indiction(year: cint): cint; cdecl; external;
 ...
 *)
function julian_period(year: cint): cint; cdecl; external;
 ...
 *)
function date_to_jdn(style: cint; year: cint; month: cint; day: cint): cint; cdecl; external;
 ...
 * Reference: Section 2.16.1 of version 2.9 of the FAQ.
 *)
procedure jdn_to_date(style: cint; JD: cint; var year: cint; var month: cint; var day: cint); cdecl; external;
 ...
 *)
procedure week_number(year: cint; month: cint; day: cint; var week_number: cint; var week_year: cint); cdecl; external;
